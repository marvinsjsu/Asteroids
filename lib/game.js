(function(root) {
  ...
  Game.prototype.add = function(obj) {
    ...
    if (obj instanceof Asteroids.Bullet) {
      ...
      $("#accuracy").html(Math.round((((game.shots - game.misses) / game.shots) * 100), -1) + "%");
      ...
      array.forEach(function(otherObj, idx) {
        ...
        if (index != idx && obj.isCollidedWith(otherObj)) {
          ...
          if (obj instanceof Asteroids.Ship && otherObj instanceof Asteroids.Asteroid) {
            game.ship.relocate();
            $("#score-history").prepend("<li> You scored: "+game.score+", fired "+game.shots+" and missed " +game.misses+ " times</li>");
            game.score = 0;
            game.shots = 0;
            game.misses = 0;
